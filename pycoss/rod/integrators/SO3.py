...
def integrator_UD_SO3(c_th, c_pi, c_V, c_Omg, t, dt, compute_F, compute_M, path_handler, alpha, mI, imI, lmbd, taylor_tol,
    ...
    th, pi, F, M, eF, eM, V, Omg, L, du_Omg, _d_A_dot_N, f_buffer2, _th, _pi  = get_buffers(f_shape, 14)
    ...
    clear_buffer(f_shape, 14)
    clear_buffer((3,3,Mm), 3)
    clear_buffer(Mm, 2)

    return th, pi, V, Omg, L, F, M

def integrator_KE_SO3(c_th, c_pi, t, dt, compute_V, compute_Omg, path_handler, lmbd, taylor_tol, pre_transform=None, post_transform=None):
    f_buffer = path_handler.f_buffer
    c_shape = path_handler.c_shape
    f_shape = path_handler.f_shape
    Mm = path_handler.Mm
