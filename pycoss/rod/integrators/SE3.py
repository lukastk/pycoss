...
def integrator_OD_SE3(c_th, c_pi, t, dt, compute_F, compute_M, path_handler, lmbd, taylor_tol, pre_transform=None, post_transform=None,
    ...
    th, pi, F, M, eF, eM, V, Omg, p, q, du_V, du_Omg, _d_A_dot_N, f_buffer2  = get_buffers(f_shape, 14)
...
def integrator_UD_SE3(c_th, c_pi, c_V, c_Omg, t, dt, compute_F, compute_M, path_handler, alpha, mI, imI, lmbd, taylor_tol,
    ...
    th, pi, F, M, eF, eM, V, Omg, L, p, q, du_V, du_Omg, _d_A_dot_N, f_buffer2, _th, _pi  = get_buffers(f_shape, 17)
    Omg_hat, d_A, B = get_buffers((3,3,Mm), 3)
    Omg_norm, psi = get_buffers(Mm, 2)
    taylor_mask = np.zeros(Mm, dtype=bool)
